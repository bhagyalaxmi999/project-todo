...
let contacts = JSON.parse(localStorage.getItem('contacts')) || []; //JSON.parse => string to json conversation
...
export const createContact = (contact) => {
    ...
    // check if mobile exists in database or not
    ...
    if(extEmail) {
        ...
        // if mobile and email not exists => store new contact data in local stroage
